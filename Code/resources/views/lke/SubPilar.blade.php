    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                @php
                    $kembali = substr($pilar->id, 0, 2);
                @endphp
                <a href="/subrincian/{{ $kembali }}" class="btn btn-secondary"><i class="fa fa-backward"></i>
                    Kembali</a>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('subPilar') is-invalid  @enderror"
        ...
        <div class="modal fade" id="edit{{ $value['id'] }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" action="/subpilar/{{ $value['id'] }}">
                        @method('put')
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="subPilar">SubPilar</label>
                                        <input type="text"
                                            class="form-control @error('subPilar') is-invalid  @enderror" id="subPilar"
                                            name="subPilar" value="{{ old('subPilar', $value->subPilar) }}"
                                            placeholder="Isi Nama subPilar">
                                        @error('subPilar')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-primary">Update SubPilar</button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
        ...
        <div class="modal fade" id="hapus{{ $value->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="/subpilar/{{ $value->id }}" method="POST" class="d-inline">
                        @method('delete')
                        @csrf
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
